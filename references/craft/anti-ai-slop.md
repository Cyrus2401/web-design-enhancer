<!--
  Vendored from nexu-io/open-design @ 009ff65 (Apache-2.0).
  Upstream origin: refero_skill (https://github.com/referodesign/refero_skill, MIT).
  Integrated into web-design-enhancer-pro as the human-maintained canon behind
  scripts/detect_ai_slop.py (see CANON_DEFAULT_INDIGO). Do not edit the seven
  cardinal sins here without re-syncing the detector — tests/test_anti_slop_canon_sync.py
  enforces this. Full attribution: references/craft/ATTRIBUTION.md & NOTICE.
-->
